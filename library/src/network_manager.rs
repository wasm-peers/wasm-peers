...
use web_sys::{RtcDataChannel, RtcDataChannelEvent, RtcIceCandidate, RtcIceCandidateInit, RtcIceConnectionState, RtcSdpType, RtcSessionDescriptionInit, WebSocket};
...
impl NetworkManager {
    pub fn start(session_id: String, connection_type: ConnectionType, is_host: bool) -> Result<Rc<RefCell<Self>>, JsValue> {
